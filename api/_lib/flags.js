...
const SEED_FLAGS = [
  ...
  // Wave 3 — Inquiry detail editable notes
  { name: 'inquiry_notes_editor_v1', description: 'Editable notes textarea on inquiry detail panel (staff-facing free-text annotations, persisted to inquiry record)' },
];
