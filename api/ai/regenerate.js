 ...
 * Re-runs AI draft generation with the same inquiry context plus optional addedContext.
 *
 * Body: { inquiryId, draftType: 'email'|'quote_reply'|'text', addedContext?, existingDraft? }
...
module.exports = async (req, res) => {
  ...
  const { inquiryId, draftType, addedContext, existingDraft } = body;
  ...
  try {
    const draft = await generateDraft({ inquiry, draftType, addedContext, existingDraft });
