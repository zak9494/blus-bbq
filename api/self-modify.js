...
const STATIC_MODULE_FILES = [
  ...
  'api/_lib/notification-types.js',
  'api/_lib/cadence-scheduler.js',
  'api/flags.js',
  ...
  'api/_lib/ai-draft.js',
  'api/_lib/quote-update-queue.js',
  'api/_lib/dessert-trigger.js',
  'api/_lib/post-event-archive.js',
  'api/_lib/guest-count-lockin.js',
  'api/ai/regenerate.js',
  'api/ai/add-details.js',
  'api/ai/quote-update-scan.js',
  'api/ai/quote-updates.js',
  'api/ai/quote-updates/[id].js',
  'api/ai/thank-you-draft.js',
  'api/cron/post-event-archive.js',
  'api/settings/guest-count-lockin.js',
  'static/js/status-sync.js',
  'static/js/kanban-view.js',
  ...
  // Group 9 extended — overdue widget, quote templates, weekly digest
  ...
  // Wave 3 — Advance follow-up calendar (advance_followup_v1)
  'static/js/advance-followup.js',
  'static/css/advance-followup.css',
];
